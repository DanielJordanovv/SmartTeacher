        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EductionForm = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    QualificationStage = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EducationOrganisiation = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FormOfEducationId = table.Column<int>(type: "int", nullable: false),
                    HoursOfEducation = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_FormOfEducations_FormOfEducationId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Institution = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    ...
                    DimplomaNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Diploma_QualificationLevels_QualificationLevelId",
                        column: x => x.QualificationLevelId,
                        principalTable: "QualificationLevels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Diploma_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestPeriods_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "QualificationStage", "QualificationType" },
                values: new object[,]
                {
                    { 1, "Средно", "Основен Втори Етап" },
                    { 2, "Средно", "Профилирани Гимназии (форма IX до XII - Професионално средно образование)" },
                    { 3, "Средно", "Професионални гимназии и/или техникуми (Професионално средно образование)" },
                    { 4, "Средно", "Професионални училища (Професионално средно образование)" },
                    { 5, "Средно", "Средно образование" },
                    { 6, "Висше", "Бакалавър" },
                    { 7, "Висше", "Магистър" },
                    { 8, "Висше", "Доктор" },
                    { 9, "Висше", "Обучение на предучилищни и учители в началните класове" },
                    { 10, "Висше", "Обучение на учители в средните училища" },
                    { 11, "Начално", "Основен Първи Етап" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_FormOfEducationId",
                table: "Courses",
                column: "FormOfEducationId");

            migrationBuilder.CreateIndex(
                name: "IX_Diploma_QualificationLevelId",
                table: "Diploma",
